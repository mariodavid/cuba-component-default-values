...
/**
 * Custom datasource used in the {@code appconfig-browse.xml} screen
 */
public class AppConfigurationDatasource extends CustomHierarchicalDatasource<AppPropertyEntity, UUID> {
    ...
    protected Collection<AppPropertyEntity> getEntities(Map<String, Object> params) {
        ...
        String scope = "appconfig";
        entities = entities.stream()
                .filter(it -> it.getName().toLowerCase().contains(scope.toLowerCase()))
