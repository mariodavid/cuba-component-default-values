...
public class DdcdvTestContainer extends TestContainer {

    public DdcdvTestContainer() {
        super();
        appComponents = new ArrayList<>(Arrays.asList(
                "com.haulmont.cuba",
                // add CUBA premium add-ons here
                "com.haulmont.addons.cuba.jpa.repositories"
                // "com.haulmont.charts",
                // "com.haulmont.fts",
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/addons/cuba/jpa/repositories/app.properties",
                // Add this file which is located in CUBA and defines some properties
                // specifically for test environment. You can replace it with your own
                // or add another one in the end.
                "com/haulmont/cuba/testsupport/test-app.properties",
                "defaultvalues-test-app.properties"
                );
        initDbProperties();
    }
    ...
    public static class Common extends DdcdvTestContainer {

        public static final DdcdvTestContainer.Common INSTANCE = new DdcdvTestContainer.Common();
